...
<!--
  ...
  2) METRICS (lowlighter)
     Create .github/workflows/metrics.yml with:
     ...
     Requires a Personal Access Token (repo, read:user scopes) saved as
     the METRICS_TOKEN secret in this repo's settings.

  Both actions commit their SVG output back to the repo (snake -> "output"
  branch, metrics -> main), which is what the <img> tags above point to.
  ===========================================================
-->
